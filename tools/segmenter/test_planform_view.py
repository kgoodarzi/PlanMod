...
import cv2
import uuid
from tools.segmenter.models import PageTab, SegmentedObject, ObjectInstance, SegmentElement, DynamicCategory
from tools.segmenter.config import AppSettings
...
class TestPlanformViewCreation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from tools.segmenter.models import create_default_categories
